    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", fontSize: 22, fontWeight: 400, opacity: 0.95 }}>
            {dateStr}
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ display: "flex", color: "#888", fontWeight: 400 }}>−</span>
          ...
          >
            <div style={{ display: "flex", borderBottom: "1px solid #e2e6e2" }}>
              <div
                style={{
                  width: labelWidth,
                  display: "flex",
