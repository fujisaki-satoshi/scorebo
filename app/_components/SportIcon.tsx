  ...
  if (sport === "baseball") {
    return (
      <svg
        ...
        aria-hidden="true"
      >
        <circle cx="12" cy="12" r="9.4" fill="#fff" stroke="#1a1a1a" strokeWidth="2" />
        <path
          d="M6.6 5.2 Q10.4 12 6.6 18.8"
          fill="none"
          stroke="#d93025"
          strokeWidth="1.9"
          strokeLinecap="round"
        />
        <path
          d="M17.4 5.2 Q13.6 12 17.4 18.8"
          fill="none"
          stroke="#d93025"
          strokeWidth="1.9"
          strokeLinecap="round"
  ...
  if (sport === "softball") {
    return (
      <svg
        ...
        aria-hidden="true"
      >
        <circle cx="12" cy="12" r="9.4" fill="#f4c430" stroke="#1a1a1a" strokeWidth="2" />
        <path
          d="M6.6 5.2 Q10.4 12 6.6 18.8"
          fill="none"
          stroke="#d93025"
